...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String get connect_robot_subtitle =>
      'Choose an address or Robothotspot connection';

  @override
  String get connection_address_mode => 'Address';

  @override
  String get connection_hotspot_mode => 'Robot Hotspot';

  @override
  String get connection_address => 'IP or Connection URL';

  @override
  String get connection_address_hint =>
      'For example 192.168.50.1 or ws://192.168.50.1:8081/ws/robot';

  @override
  String get connection_hotspot_title => 'Robot Hotspot Connection';

  @override
  String get connection_hotspot_description =>
      'Connect this device to the RobotWi-Fi hotspot in system settings, then open the Socket connection.';

  @override
  String get connection_hotspot_web_description =>
      'Connect this device to the RobotWi-Fi hotspot, then use the button below to connect to the robot.';

  @override
  String get connection_hotspot_app_description =>
      'Open the system Wi-Fi list and select the Robothotspot. The app checks and connects automatically when you return.';

  @override
  String get connection_hotspot_connect => 'Connect RobotDevice';

  @override
  String get connection_hotspot_open_wifi => 'Open Wi-Fi Settings';

  @override
  String get connection_hotspot_check_now => 'Connected? Check Now';

  @override
  String get connection_hotspot_checking => 'Checking Robotdevice…';

  @override
  String get connection_hotspot_auto_hint =>
      'The app checks automatically when you return and opens the map after a successful connection.';

  @override
  String get connection_hotspot_retry_hint =>
      'Robot is not reachable yet. Confirm the correct hotspot and check again.';

  @override
  String get connection_hotspot_open_wifi_failed =>
      'Wi-Fi settings could not be opened. Open them manually from system settings.';

  @override
  String get connection_address_invalid =>
      'Invalid address. Enter an IP, host:port, or a full URL.';
