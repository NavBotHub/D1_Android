...
abstract class AppLocalizations {
  ...
  /// No description provided for @connection_address_mode.
  ///
  /// In zh, this message translates to:
  /// **'地址连接'**
  String get connection_address_mode;

  /// No description provided for @connection_hotspot_mode.
  ///
  /// In zh, this message translates to:
  /// **'Robot 热点'**
  String get connection_hotspot_mode;

  /// No description provided for @connection_address.
  ///
  /// In zh, this message translates to:
  /// **'IP 或连接链接'**
  String get connection_address;

  /// No description provided for @connection_address_hint.
  ///
  /// In zh, this message translates to:
  /// **'例如 192.168.50.1 或 ws://192.168.50.1:8081/ws/robot'**
  String get connection_address_hint;

  /// No description provided for @connection_hotspot_title.
  ///
  /// In zh, this message translates to:
  /// **'Robot 热点直连'**
  String get connection_hotspot_title;

  /// No description provided for @connection_hotspot_description.
  ///
  /// In zh, this message translates to:
  /// **'请先在系统 Wi-Fi 设置中连接 Robot设备热点，然后建立 Socket 连接。'**
  String get connection_hotspot_description;

  /// No description provided for @connection_hotspot_web_description.
  ///
  /// In zh, this message translates to:
  /// **'先将当前设备连接到 RobotWi-Fi 热点，再点击下方按钮连接机器人。'**
  String get connection_hotspot_web_description;

  /// No description provided for @connection_hotspot_app_description.
  ///
  /// In zh, this message translates to:
  /// **'打开系统 Wi-Fi 列表并选择 Robot热点；返回 App 后将自动检测并连接机器人。'**
  String get connection_hotspot_app_description;

  /// No description provided for @connection_hotspot_connect.
  ///
  /// In zh, this message translates to:
  /// **'连接 Robot设备'**
  String get connection_hotspot_connect;

  /// No description provided for @connection_hotspot_open_wifi.
  ///
  /// In zh, this message translates to:
  /// **'打开 Wi-Fi 设置'**
  String get connection_hotspot_open_wifi;

  /// No description provided for @connection_hotspot_check_now.
  ///
  /// In zh, this message translates to:
  /// **'已连接热点？立即检测'**
  String get connection_hotspot_check_now;

  /// No description provided for @connection_hotspot_checking.
  ///
  /// In zh, this message translates to:
  /// **'正在检测 Robot设备…'**
  String get connection_hotspot_checking;

  /// No description provided for @connection_hotspot_auto_hint.
  ///
  /// In zh, this message translates to:
  /// **'从 Wi-Fi 设置返回后会自动检测，连接成功后直接进入地图。'**
  String get connection_hotspot_auto_hint;

  /// No description provided for @connection_hotspot_retry_hint.
  ///
  /// In zh, this message translates to:
  /// **'暂未连接到 D1，请确认已选择正确热点后重新检测。'**
  String get connection_hotspot_retry_hint;

  /// No description provided for @connection_hotspot_open_wifi_failed.
  ///
  /// In zh, this message translates to:
  /// **'无法打开 Wi-Fi 设置，请从系统设置中手动打开。'**
  String get connection_hotspot_open_wifi_failed;

  /// No description provided for @connection_address_invalid.
  ///
  /// In zh, this message translates to:
  /// **'连接地址无效，请输入 IP、host:port 或完整链接'**
  String get connection_address_invalid;
